    ...
    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12">
            <div className="mx-auto w-full">
                <h1 className="text-center text-2xl font-bold leading-9 text-gray-900">Adoption Form</h1>
                <p className="mt-5 text-center text-2xl leading-6">Please fill out the following adoption form to adopt this cutie!</p>
            </div>
            <div className="mt-10 sm:mx-auto sm:w-full max-w-lg">
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button className="flex w-full justify-center rounded-md bg-gray-800 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" type="submit">Submit</button>
                </form>
            </div>
        </div>
    )
